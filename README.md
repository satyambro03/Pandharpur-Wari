...
[![Live Demo](https://img.shields.io/badge/🚀_Live_Demo-pandharpurwari--gray.vercel.app-FF7A00?style=for-the-badge&logo=vercel&logoColor=white)](https://pandharpurwari-gray.vercel.app/)
...
[![Languages](https://img.shields.io/badge/Languages-Marathi_%7C_Hindi_%7C_English-FF9933?style=for-the-badge)](https://pandharpurwari-gray.vercel.app/)

<br />

<img src="./docs/screenshots/banner.jpg" alt="WariRakshak Hero Banner" width="100%" style="border-radius: 16px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);" />
...
<div align="center">
  <img src="./docs/screenshots/map_view.jpg" alt="WariRakshak GIS Crowd Map" width="100%" style="border-radius: 12px; margin: 12px 0;" />
</div>
...
<div align="center">
  <img src="./docs/screenshots/pilgrim_ui.jpg" alt="Pilgrim Companion and SOS System" width="100%" style="border-radius: 12px; margin: 12px 0;" />
</div>
...
<div align="center">
  <img src="./docs/screenshots/tactical_dashboard.jpg" alt="Tactical Command Center" width="100%" style="border-radius: 12px; margin: 12px 0;" />
</div>
...
```mermaid
graph TD
    A[Warkari Pilgrim Presses SOS Button] -->|5s Countdown Verification| B[Automatic GPS Coordinates Capture]
    B --> C{Supabase Realtime Event Broadcast}
    C -->|High Priority Alert| D[Police Command Center Dashboard]
    C -->|Proximity Dispatch| E[Nearest Volunteer & Medical Station]
    D --> F[Status: In Progress - Police Vehicle Dispatched]
    E --> G[On-Ground First Aid & Assistance Provided]
    F --> H[Issue Resolved & Marked Complete]
```
